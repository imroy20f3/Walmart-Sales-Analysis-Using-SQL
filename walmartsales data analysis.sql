...
-- How many unique paymet method does the data have?
SELECT 
     DISTINCT payment_method
FROM sales;

-- Which cestomer type buys the most ?
SELECT 
     customer_type,
     COUNT(*) AS cstm_cnt
FROM sales
...
-- Which tme of the day do customers give most ratings?
SELECT
     time_of_day,
...
-- Which tme of the day do customers give most ratings pr branch?
SELECT
     time_of_day,
     AVG(rating) AS avg_rating
FROM sales
